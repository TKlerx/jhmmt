...
{	
	 ...
	 */
	public OpdfIntegerOld(int nbEntries)
	{
		if (nbEntries <= 0) 
	 ...
	 */
	public OpdfIntegerOld(double[] probabilities)
	{		
	...
	@Override
	public OpdfIntegerOld clone()
	{	
		try {
			OpdfIntegerOld opdf = (OpdfIntegerOld) super.clone();
