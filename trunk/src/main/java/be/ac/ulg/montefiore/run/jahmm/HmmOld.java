 ...
 */
@Deprecated
public class HmmOld<O extends Observation>
...
{		
	 ...
	 */
	public HmmOld(int nbStates, OpdfFactory<? extends Opdf<O>> opdfFactory)
	{
		if (nbStates <= 0)
	 ...
	 */
	public HmmOld(double[] pi, double[][] a, List<? extends Opdf<O>> opdfs)
	{
	...
	@Override
	public HmmOld<O> clone()
	throws CloneNotSupportedException
	{
		HmmOld<O> hmm = new HmmOld<O>(nbStates());
