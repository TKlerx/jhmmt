 ...
 */
@Deprecated
public class ForwardBackwardCalculatorOld
{	
	/**
	...
	protected ForwardBackwardCalculatorOld()
	{
	};
 ...
 ForwardBackwardCalculatorOld(List<? extends O> oseq,
	 ...
	 */
	public <O extends Observation>
 ForwardBackwardCalculatorOld(List<? extends O> oseq, Hmm<O> hmm)
	{
