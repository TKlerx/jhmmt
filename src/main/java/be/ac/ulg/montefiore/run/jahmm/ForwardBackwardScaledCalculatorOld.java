 ...
 */
@Deprecated
public class ForwardBackwardScaledCalculatorOld
 extends ForwardBackwardCalculatorOld
{
	/*
 ...
 ForwardBackwardScaledCalculatorOld(List<? extends O> oseq,
	 ...
	 */
	public <O extends Observation>
 ForwardBackwardScaledCalculatorOld(List<? extends O> oseq, Hmm<O> hmm)
	{
